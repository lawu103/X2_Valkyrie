// This is for the Damage Buff effect that comes with Odin's Blessing (duration depends on if Valhalla is unlocked)
class X2Effect_MercyClassMod_OdinBlessing extends X2Effect_MercyClassMod_DamageBuff;
