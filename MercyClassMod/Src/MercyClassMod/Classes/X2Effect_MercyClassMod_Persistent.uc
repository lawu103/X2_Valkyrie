// This class is for Valkyrie's X2Effect_Persistent effects whose duration depends on if Valhalla is unlocked
class X2Effect_MercyClassMod_Persistent extends X2Effect_Persistent;
