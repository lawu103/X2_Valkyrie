// This class is for Valkyrie's X2Effect_PersistentStatChange effects whose duration depends on if Valhalla is unlocked
class X2Effect_MercyClassMod_PersistentStatChange extends X2Effect_PersistentStatChange;
